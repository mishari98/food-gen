import { getAllMeals, getMealById } from '../database/mealRepository';
import { insertDayPlan, deleteWeekPlans } from '../database/planRepository';
import { getMealsPerDay } from './preferenceManager';
import { DayPlan, Meal } from '../types/meal';
import { getSlotsForMealsPerDay, MealSlotName } from '../utils/constants';
